    ...
    <aside className="w-64 bg-gradient-to-b from-[#80361F] to-[#473354] text-white flex flex-col justify-between">
            <div>
              ...
              <div className="px-6">
                ...
                {/* Categories */}
                <div>
                  <h3 className="text-sm uppercase mb-2 tracking-wide text-gray-200">Category</h3>
                  <div className="space-y-2">
                {categories.map((cat) => (
                  <button
                    key={cat.name}
                    className="w-full flex items-center gap-2 px-3 py-2 rounded-md bg-white/10 hover:bg-white/20 transition"
                  >
